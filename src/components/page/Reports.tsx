  ...
  return (
    <>
      ...
      <div className="mt-3 d-flex gap-3">
        <BarChartComponent
          aggregatedData={groupByField(jsonData, "Region", "Sum").filter(
            ({ Group }) => Group === "Buxoro va Navoiy",
          )}
          xOffset={45}
          height={400}
        />
      ...
      <div className="mt-3 d-flex gap-3">
        ...
        <BarChartComponent
          aggregatedData={groupByField(jsonData, "Region", "Sum").filter(
            ({ Group }) => Group === "Eksport (kushni emas)",
          )}
          xOffset={45}
          height={400}
        />
      ...
      <div className="mt-3 d-flex gap-3">
        <BarChartComponent
          aggregatedData={groupByField(jsonData, "Region", "AKB").filter(
            ({ Group }) => Group === "Buxoro va Navoiy",
          )}
          xOffset={45}
          height={400}
      ...
      <div className="mt-3 d-flex gap-3">
        <BarChartComponent
          aggregatedData={groupByField(jsonData, "Product", "Sum").filter(
            ({ Group }) => Group === "RSC",
          )}
          xOffset={45}
          height={400}
      ...
      <div className="mt-3 d-flex gap-3">
        <BarChartComponent
          aggregatedData={groupByField(jsonData, "Product", "AKB").filter(
            ({ Group }) => Group === "RSC",
          )}
          xOffset={45}
          height={400}
