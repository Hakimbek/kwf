      ...
      <div className="report-wrapper">
        ...
        <div className="report">
          <div className="d-flex flex-fill gap-1">
            ...
            <BarChartComponent type="Sum" data="kwfData" managerName={manager} productName="Гофролист" title="Гофролист" />
            {/*<BarChartComponent type="Sum" data="kwfData" managerName={manager} productName="Монокартон" title="Монокартон" />*/}
          </div>
          <div className="d-flex flex-fill gap-1">
            <BarChartComponent type="Sum" data="kwfData" managerName={manager} regionName="Бухоро ва Навоий вилояти" title="Buxoro va Navoiy" />
            <BarChartComponent type="Sum" data="kwfData" managerName={manager} regionName="Водий: ФАН" title="Vodiy: FAN" />
            <BarChartComponent type="Sum" data="kwfData" managerName={manager} regionName="Кашкадарё ва Сурхондарё вилояти" title="Kash va Surx" />
            <BarChartComponent type="Sum" data="kwfData" managerName={manager} regionName="Самарканд, Жиззах ва Сирдайрё вилояти" title="Sam, Jizz, Sir" />
            <BarChartComponent type="Sum" data="kwfData" managerName={manager} regionName="Тошкент вилояти ва шахри" title="Toshkent" />
            <BarChartComponent type="Sum" data="kwfData" managerName={manager} regionName="Хоразм вилояти ва Коракалпогистон" title="Xorazm va QQP" />
            <BarChartComponent type="Sum" data="kwfData" managerName={manager} regionName="Экспорт (кушни)" title="Eksport (kushni)" />
          ...
          <div className="d-flex flex-fill gap-1">
            ...
            <BarChartComponent type="AKB" data="kwfData" managerName={manager} productName="Гофролист" title="Гофролист" />
            {/*<BarChartComponent type="AKB" data="kwfData" managerName={manager} productName="Монокартон" title="Монокартон" />*/}
          </div>
          <div className="d-flex flex-fill gap-1">
            <BarChartComponent type="AKB" data="kwfData" managerName={manager} regionName="Бухоро ва Навоий вилояти" title="Buxoro va Navoiy" />
            <BarChartComponent type="AKB" data="kwfData" managerName={manager} regionName="Водий: ФАН" title="Vodiy: FAN" />
            <BarChartComponent type="AKB" data="kwfData" managerName={manager} regionName="Кашкадарё ва Сурхондарё вилояти" title="Kash va Surx" />
            <BarChartComponent type="AKB" data="kwfData" managerName={manager} regionName="Самарканд, Жиззах ва Сирдайрё вилояти" title="Sam, Jizz, Sir" />
            <BarChartComponent type="AKB" data="kwfData" managerName={manager} regionName="Тошкент вилояти ва шахри" title="Toshkent" />
            <BarChartComponent type="AKB" data="kwfData" managerName={manager} regionName="Хоразм вилояти ва Коракалпогистон" title="Xorazm va QQP" />
            <BarChartComponent type="AKB" data="kwfData" managerName={manager} regionName="Экспорт (кушни)" title="Eksport (kushni)" />
